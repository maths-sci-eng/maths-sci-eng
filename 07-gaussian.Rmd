...
\end{align*}
where $x_3$ and $x_5$ are free variables, and hence we can set them as parameterise $x_3=\beta$, $x_4=\gamma$. Since we have 2 parameters, this describes a plane in 5-dimensional space. The solution is all points
