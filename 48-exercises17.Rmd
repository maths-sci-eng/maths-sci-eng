...
|49|54|68|35|64|67|76|73|68|61|
    ...
    a. Reduce these marks to a frequency distribution, with equal class widths, having as the first interval 35-44 inclusive. Draw a smoothed ogive for the distribution.
...
1.  In an examination, the marks awarded to the first 40 scripts were:
    ...
    a. Taking classes 14.5-24.5, 24.5-34.5, 34.5-44.5 etc, draw up a frequency distribution table for the marks. Estimate also the relative frequency, cumulative frequency and relative cumulative frequency.
