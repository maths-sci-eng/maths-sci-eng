...
$$2x+C$
where $C$ is a constant would yield the same derivative. Therefore, the best we can do is to say the integral of $f(x)=2x$ has the form $x^2+C$.
...
To find the definite integral we can make use of part 2 of the FTC.
