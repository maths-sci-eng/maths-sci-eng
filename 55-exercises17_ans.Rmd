...
hist(y, main = "Histogram of exam marks", xlab = "Exam mark", ylab="Frequency",breaks = c(50,60,70,80,90,100), ylim=c(0,25))
```
...
hist(x, main = "Histogram of carbon %", xlab = "Exam mark", ylab="Frequency",breaks = c(4.10,4.20,4.30,4.40,4.50,4.60,4.70,4.80,4.90,5.00,5.10,5.20), xlim=c(4.1,5.2), ylim=c(0,40))
```
...
1. A city has been criticized for its excessive discharges of untreated sewage into the nearby river. A microbiologist take 45 samples of water downstream from the treated sewage outlet and measures the number of bacteria present. A summary table is as follows:
    ...
    $Q_3$ is between item 34 and 35, which lies in class 40-50. Within this class, there are 9 values before $Q_3$ and 6 values after: that is, $\frac{6}{10}$ of the interval lies before and $\frac{4}{10}$ after. The class width is 10. Therefore, $Q_1=40+6=46$.
