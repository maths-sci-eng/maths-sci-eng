...
1. This is a harder question using trigonometric identities (not examinable). Here we shall derive a special (slightly simpler) case of the sum of two sinusoidal waves of the same frequency that was shown in lectures. We will consider two waves of the form
...
where $x$ is the distance of the mass from its equilibrium position, $\omega$ is the natural frequency of oscillations, and $A_1$ and $A_2$ are constants. For $A_1=\sqrt{3}$, $A_2=1$ and $\omega=10$:
