...
A particularly common form of equation that arise in science and engineering are *quadratic* equations. These are equations of the form
...
If we can write a quadratic equation as a product of two simpler factors in the form^[Actually, any quadratic can be factorised as a product of two linear factors, but we may need complex numbers to do this; more on this in section \@ref().]:
...
::: {.exercise #quadfact}
The quadratic formula finds the solutions to $ax^2+bx+c=0$. How do you then find the factorisation of the quadratic?
:::

::: {.exercise #quadform}
Derive the quadratic formula. Hint: use the method of "completing the square".
:::
