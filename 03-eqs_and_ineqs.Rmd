...
We explore three different methods for finding the roots of a quadratic below.
...
Recall that exponentials and logarithms are inverses of one another. When solving equations involing exponentials and logarithms, we usually need to apply the inverse in order to extract the $x$ variable, and make use of the rules of exponentials and logarithms. We shall illustrate this with a series of examples.
