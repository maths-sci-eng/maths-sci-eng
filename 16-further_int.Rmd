...
* If $q(x)$ contains an irreducible quadratic factor --- factors of the form $x^2+bx+c$ that cannot be factorised into a product of linear factors $(x-\alpha)(x-\beta)$ with integer coefficients --- then the numerator in the partial fractions will be a linear polynomial. For example,
