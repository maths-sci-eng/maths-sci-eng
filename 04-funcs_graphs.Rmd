...
The higher the degree of the polynomial, the more "wavey" its graph can be.
...
factorising (remainder theorem, factor theorem)
quadratics
roots
division, remainders, partial fractions
