...
1. In a meal deal you can choose any 3 different items from: sandwich, wrap, pasta, sushi, crisps, drink, chocolate. How many different meal deals are there?
...
1. A poker hand consists of 5 cards from a standard 52 card deck. How many diferent poker hands are there? How many poker hands are there of each of the following types?
    ...
    There are ${ 52 \choose 5}=2598960$ poker hands in total.
